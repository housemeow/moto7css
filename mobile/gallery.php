	  ...
	  <div data-role="main" class="pagecontent ui-content">
		...
		<div class="content">
            ...
            <div class="articleList newsContainer">
            	<a class="articleItem newsItem galleryItem" href="gallerypost.php">
                	<img src="<?php echo $upload_path ?>img_89x59.jpg"/>
                    <div class="articleInfo">
						<span class="tag">新聞</span>
                        <span class="comment"><i class="fa fa-picture-o fa-lg"></i>12,136</span>
						<h1>SUZUKI 新色登場：感受戰鬥機般的靈巧活力</h1>
                    </div>
                </a>
                <a class="articleItem newsItem galleryItem" href="gallerypost.php">
                	<img src="<?php echo $upload_path ?>img_89x59.jpg"/>
