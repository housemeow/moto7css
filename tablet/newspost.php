    	...
    	<div class="container">
	    	<div class="two_right left">
                ...
                <div class="articlePost">
                	<div class="articleTitle newsTitle">
                    ...
                    <div class="articleContent">
                        ...
                        <div class="hit">
                        	<img src="<?php echo $upload_path ?>img_682x452.jpg" width="485">
                        </div>
                      ...
                      <p>HONDA自1964年開始為回饋交通安全，開始研究交通安全，並且在Suzuka 設立第一間交通安全中心，直至今日在日本境內共有7間交通安全中心，另外在37個國家也都有安駕中心或活動進行，旨在進行社會回饋，提升交通安全，新竹安駕中心的前身也曾是HONDA 交通安全中心，在HONDA 與三陽分家後，才獨立出來。</p>
                        <img src="<?php echo $upload_path ?>img01.jpg" width="499">
                      ...
                      <p>Suzuka 交通安全中心位於鈴鹿國際賽車場旁，擁有佔地70,000平方米的場地，整個訓練設施包含一般環場道路、道路實境模擬、低摩擦係數路面、剎車訓練場、雨天訓練場、中低速綜合訓練場、模擬市區道路以及主建築，其設施極為完善，搭配HONDA 交通安全研究團隊四十多年來的研究結晶，成為交通安全研究的指標性學校。</p>
                        <img src="<?php echo $upload_path ?>img02.jpg" width="499">
                        <div class="articleFooter">
                        	<a class="btn btn-default" href="#"><i class="fa fa-reply"></i><br />
                       	  返回</a>
                            ...
                            <a class="btn btn-primary" href="#"><div class="post next"><span>青春無敵，我的生活，我的MY150 檔車教學特輯</span></div><div class="arrow next"><i class="fa fa-arrow-right"></i><br />下一則</div></a>
                      </div>
                    </div>
                    <div class="relatedPosts">
                        ...
                        <div class="hilightnews">
                            <div>
                                <a href="#">
                                    <img src="../upload/img_165x110.jpg" width="114">
                    ...
                    <div class="relatedPosts comments">
                            ...
                            <div class="commentPost">
                            	...
                            	<div class="comment">
                                    ...
                                    <div class="postText">
                                        ...
                                        <span class="txt">我比較在意的還是引擎部分~我比較在意的還是引擎部分我比較在意的還是引擎部分</span>
                                    </div>
                                    <div class="commentFeed">
                                        ...
                                        <div class="comment">
                                            <span class="date">六月 20, 2012 於 2:53 下午</span>
                                            <div class="postText">我比較在意的還是引擎部分~我比較在意的還是引擎部分我比較在意的還是引擎部分</div>
                                        </div>
                                    </div>
                                </div>
                                <a class="btn btn-default btn-lg" href="#"><i class="fa fa-comment"></i></a>
            ...
            <div class="two_left right">
                ...
                <div class="event">
	    			...
	    			<div class="content">
	    				<ul class="relatedProducts center">
                        	<li>
                ...
                <div class="event">
	    			...
	    			<div class="content">
	    				<ul class="relatedProducts">
                        	<li>
                            	<img src="<?php echo $upload_path ?>img_84x63.jpg">
                                <span>MOTOREX TOP SPEED 4T 5W40</span>
                                <a href="#">部品專頁</a>
                            </li>
                        </ul>
	    			</div>
