	    	...
	    	<div class="two_left">
                ...
                <div class="articlePost">
                    ...
                    <div class="articleContent">
                    	<a class="btn btn-default" href="news.php"><i class="fa fa-reply"></i> 返回</a>
                        ...
                        <div class="articleFooter">
                        	<a class="btn btn-default" href="news.php"><i class="fa fa-reply"></i><br />返回</a>
                            ...
                            <div class="commentPost">
                            	...
                            	<div class="comment">
                                    ...
                                    <div class="postText">
                                        ...
                                        <span class="txt">我比較在意的還是引擎部分~我比較在意的還是引擎部分~我比較在意的還是引擎部分~我比較在意的還是引擎部分~</span>
                                    </div>
                                    <div class="commentFeed">
                                        ...
                                        <div class="comment">
                                            <span class="date">六月 20, 2012 於 2:53 下午</span>
                                            <div class="postText">我比較在意的還是引擎部分~我比較在意的還是引擎部分~我比較在意的還是引擎部分~我比較在意的還是引擎部分~</div>
                                        </div>
                                    </div>
                                </div>
                                <a class="btn btn-default btn-lg" href="#"><i class="fa fa-comment"></i></a>
