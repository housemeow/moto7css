		...
		<div class="content">
			...
			<div class="container">
				...
				<div class="three_center">
					...
					<ul class="bxslider">
						<li><img src="<?php echo $upload_path ?>img1_626x418.jpg" title="測試圖片1" link="#"/></li>
						<li><img src="<?php echo $upload_path ?>img2_626x418.jpg" title="測試圖片2" link="#"/></li>
						<li><img src="<?php echo $upload_path ?>img3_626x418.jpg" title="測試圖片3" link="#"/></li>
						<li><img src="<?php echo $upload_path ?>img4_626x418.jpg" title="測試圖片4" link="#"/></li>
						<li><img src="<?php echo $upload_path ?>img5_626x418.jpg" title="測試圖片5" link="#"/></li>
					</ul>
					<div class="news">
						...
						<div class="hilightnews">
							<div>
								<a href="#">
									<img src="<?php echo $upload_path ?>img_135x90.jpg"/>
					...
					<div class="middleAD">
						<img src="<?php echo $upload_path ?>ad_320x50.gif">
						<img src="<?php echo $upload_path ?>ad_320x50.gif">
					</div>
					<div class="news">
