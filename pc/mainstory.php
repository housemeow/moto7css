			...
			<ul class="block-panel">
			    <li class="left-image-panel">
			        ...
			        <div class="right-info background">
			            ...
			            <div class="content">
			                摩托車綜合購物網站「Webike」自2000年在日本開幕，14年來已成為日......<font class="more">[ more ]</font>
			            </div>
			        </div>
			    </li>
			    <li class="right-image-panel">
			        <div class="left-info background">
			        	<div class="title">
			                ...
			                <div class="info">MTOT7 教練團日本 Suzuka 安駕訓練受訓紀實</div>
			            </div>
			            <div class="content">
			                為了精進MOTO7 教練團騎乘技術，提升騎術訓練活動以及安全駕駛內容，MOTO7 主編楊斌與安駕講師小天特別安排到日本的Suzuka 安全駕駛教育中心，來學習最新的騎乘技巧與觀念<font class="more">[ more ]</font>
			            </div>
			        </div>
